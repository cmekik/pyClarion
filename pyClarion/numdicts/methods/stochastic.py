...
def stduniformvariate(self: D, c: float = math.nan) -> D:
    it = self._d if math.isnan(self._c) else self._i
    d = {k: random.random() for k in it} 
    return type(self)(self._i, d, c, False)


def normalvariate(self: D, sigma: D, *, by: KeyForm | None = None, c: float = math.nan) -> D:
...
def lognormvariate(self: D, sigma: D, *, by: KeyForm | None = None, c: float = math.nan) -> D:
    mode = "self" if math.isnan(self._c) else "full"
...
def vonmisesvariate(self: D, kappa: D, *, by: KeyForm | None = None, c: float = math.nan) -> D:
    mode = "self" if math.isnan(self._c) else "full"
...
def expovariate(self: D, c: float = math.nan) -> D:
    it = self._d if math.isnan(self._c) else self._i
    d = {k: random.expovariate(self[k]) for k in it} 
    return type(self)(self._i, d, c, False)


def gammavariate(self: D, sigma: D, *, by: KeyForm | None = None, c: float = math.nan) -> D:
    mode = "self" if math.isnan(self._c) else "full"
...
def paretovariate(self: D, c: float = math.nan) -> D:
    it = self._d if math.isnan(self._c) else self._i
    d = {k: random.paretovariate(self[k]) for k in it} 
    return type(self)(self._i, d, c, False)


def logisticvariate(self: D, scale: D, *, by: KeyForm | None = None, c: float = math.nan) -> D:
    mode = "self" if math.isnan(self._c) else "full"
...
def gumbelvariate(self: D, beta: D, *, by: KeyForm | None = None, c: float = math.nan) -> D:
    mode = "self" if math.isnan(self._c) else "full"
